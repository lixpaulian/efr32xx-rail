...
#define USTIMESTAMP32_TIMER         (TIMER0)
#define USTIMESTAMP32_TIMER_CLOCK   (cmuClock_TIMER0)
#define USTIMESTAMP32_TIMER_IRQ     (TIMER0_IRQn)
...
static uint32_t ustimestamp32 = 0;

void TIMER0_IRQHandler(void)
{
  if (TIMER_IntGet(USTIMESTAMP32_TIMER) & TIMER_IF_CC0) {
    if (ticker_int_rem > 0) {
      TIMER_CompareSet(USTIMESTAMP32_TIMER, 0, ticker_int_rem);
      ticker_int_rem = 0;
      TIMER_IntClear(USTIMESTAMP32_TIMER, TIMER_IF_CC0);
